...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Anuarag Dome</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> G.H Raisoni College of Engineering, Pune</b></p>
    </center>
